...
fn preview_for_file(
    path: &Path,
    descriptor: &aspect_core::FileViewDescriptor,
    options: &FileInspectionOptions,
...
fn text_preview(
    path: &Path,
    _descriptor: &aspect_core::FileViewDescriptor,
    options: &FileInspectionOptions,
) -> AppResult<FilePreview> {
    let metadata = fs::metadata(path)?;
...
fn image_preview(path: &Path, descriptor: &aspect_core::FileViewDescriptor) -> FilePreview {
    let ext = extension(path);
    let mime = descriptor
        .mime_type
        .clone()
...
fn audio_preview(path: &Path, descriptor: &aspect_core::FileViewDescriptor) -> FilePreview {
    let ext = extension(path);
    let mime = descriptor
        .mime_type
        .clone()
...
fn video_preview(path: &Path, descriptor: &aspect_core::FileViewDescriptor) -> FilePreview {
    let ext = extension(path);
    let mime = descriptor
        .mime_type
        .clone()
...
fn external_preview(path: &Path, descriptor: &aspect_core::FileViewDescriptor) -> FilePreview {
