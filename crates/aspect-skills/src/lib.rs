//! `aspect-skills` вЂ” discoverable, reusable instruction modules for the agent.
//!
...
//!
//! * **Project** вЂ” `<workspace>/.aspect/skills/` (travels with the repo, shareable).
//! * **Global** вЂ” `<app_data>/skills/` (the user's personal library).
//!
