...
const FILE_FORMATS: &[FileFormatSpec] = &[
    ...
    spec("Configuration", FileViewCategory::Config, FileViewStrategy::MonacoText, FileOpenMode::EditableText, Some("text/plain"), &["ini", "cfg", "conf", "config", "properties", "props", "env", "editorconfig", "npmrc", "yarnrc", "prettierrc", "eslintrc", "babelrc", "browserslistrc", "gitignore", "gitattributes", "gitmodules"], &[], false, true, &[]),
    spec("XML", FileViewCategory::Data, FileViewStrategy::MonacoText, FileOpenMode::EditableText, Some("application/xml"), &["xml", "xsd", "xsl", "xslt", "svg"], &[], false, true, &[]),
    spec("Delimited table", FileViewCategory::Spreadsheet, FileViewStrategy::TablePreview, FileOpenMode::EditableText, Some("text/csv"), &["csv", "tsv", "psv"], &[], false, true, &[]),
    ...
    spec("Programming language", FileViewCategory::Code, FileViewStrategy::MonacoText, FileOpenMode::EditableText, Some("text/plain"), &["rs", "go", "py", "pyw", "java", "kt", "kts", "c", "h", "cpp", "cc", "cxx", "hpp", "hh", "hxx", "cs", "fs", "fsx", "php", "rb", "lua", "swift", "scala", "dart", "ex", "exs", "erl", "hrl", "zig", "nim", "r", "jl", "hs", "lhs", "pl", "pm", "perl", "clj", "cljs", "cljc", "edn", "elm", "sol", "v", "sv", "svh", "asm", "s", "m", "mm"], &["dockerfile", "makefile", "rakefile", "gemfile", "procfile"], false, true, &[]),
    ...
    spec("Spreadsheet", FileViewCategory::Spreadsheet, FileViewStrategy::SpreadsheetPreview, FileOpenMode::Preview, None, &["xls", "xlsx", "xlsm", "xlsb", "ods", "fods"], &[], true, true, &[]),
    spec("Database", FileViewCategory::Database, FileViewStrategy::DatabasePreview, FileOpenMode::Preview, Some("application/vnd.sqlite3"), &["db", "db3", "sqlite", "sqlite2", "sqlite3", "s3db", "duckdb"], &[], true, true, &["SQLite databases are inspected directly; other DB file extensions are identified and routed safely."]),
    ...
    spec("Image", FileViewCategory::Image, FileViewStrategy::ImagePreview, FileOpenMode::Preview, None, &["png", "jpg", "jpeg", "jpe", "webp", "gif", "bmp", "dib", "ico", "icns", "avif", "tif", "tiff", "heic", "heif", "apng", "psd", "ai", "eps"], &[], true, true, &[]),
    ...
    spec("Archive", FileViewCategory::Archive, FileViewStrategy::ArchivePreview, FileOpenMode::Preview, None, &["zip", "rar", "7z", "tar", "gz", "tgz", "bz2", "tbz2", "xz", "txz", "zst", "br", "jar", "war", "ear", "apk", "aab", "ipa", "vsix", "nupkg", "crate", "whl", "gem"], &[], true, true, &[]),
    spec("Notebook", FileViewCategory::Notebook, FileViewStrategy::NotebookPreview, FileOpenMode::Preview, Some("application/x-ipynb+json"), &["ipynb"], &[], false, true, &[]),
