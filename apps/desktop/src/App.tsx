...
import { AI_PREFERENCES_KEY, normalizeAiPreferences } from "./lib/aspector/utils/preferences";
import { buildAiProjectIndexSnapshot } from "./lib/aspector/utils/project-index";
import { appendAiShellLiveOutput } from "./lib/aspector/utils/shell-live-output";
import { closedDocumentIdsForAllDocuments, closedDocumentIdsForDocumentInGroup } from "./lib/editor/close-targets";
...
import { DEFAULT_UI_FONT_STACK, EDITOR_PREFERENCES_KEY, normalizeEditorPreferences, withFontFallback } from "./lib/editor/preferences";
import { buildFileTreeDirectories, normalizePath } from "./lib/explorer/file-tree";
import { createKeybindingDispatcher, KEYBINDINGS_SETTINGS_KEY } from "./lib/keyboard/keybindings";
import { buildProjectLoadSummary } from "./lib/init/project-load-presentation";
import { maybeAutoInstallLanguageServers, resetLspAutoInstallAttempts } from "./lib/editor/lsp-auto-install";
import { bootstrapManagedRuntimes } from "./lib/init/runtime-bootstrap";
import { createEmptyAiIndexState, createIdleProjectLoadState, isAiChatSessionBusyStatus, useLuxStore, type Activity } from "./lib/store/index";
