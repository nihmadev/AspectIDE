...
import { decodeIpcResult, expectArray, type IpcDecoder } from "./decode";
import { readStringField, safeListen } from "./events";
import {
...
// event layer). Re-exported here so every existing `from "./commands"` import is
