...
import { defaultAiPreferences, mergeAiPreferences, type AiPreferences } from "./../aspector/utils/preferences";
import type { AiChatContextBudgetReport } from "./../aspector/chat/context-report";
import type { ContextCompactionState } from "./../aspector/chat/context-compaction";
import type { PersistedPendingFileReview } from "./../aspector/utils/pending-file-review";
import type { AiSessionTodo } from "./../aspector/session/todos";
import { disposeAiChatSessionSideState } from "./../aspector/chat/session-lifecycle";
import { normalizeAiMessageReasoning } from "./../aspector/chat/reasoning";
import type { AiChatMessage, AiMessageSegment } from "./../aspector/chat/types";
import type { AiProjectIndexBucket, AiProjectIndexFile, AiProjectIndexQuality, AiProjectIndexSource } from "./../aspector/utils/project-index";
import { defaultEditorPreferences, mergeEditorPreferences, type EditorPreferences } from "./../editor/preferences";
import { normalizePath, sameWorkspaceRoot, type FileTreeDirectories } from "./../explorer/file-tree";
import { DEFAULT_LOCALE, type Locale } from "../i18n";
import { defaultKeybindingProfile } from "./../keyboard/keybindings";
import { applyTextEdits } from "./../editor/documents/document-edits";
import {
...
import { appendTerminalChunks, emptyTerminalBuffer, terminalOutputCoalescer } from "./../terminal/output";
import type { TerminalOutputBuffer } from "./../terminal/types";
import type { DebugBreakpointsUpdate, DebugResolvedBreakpoint, DebugSourceBreakpoint, DocumentEditResult, DocumentSnapshot, FsEntry, GitStatus, KeybindingProfile, LanguageServerInfo, SearchResponse, TerminalSessionInfo, TextEdit, WorkspaceDiagnostic, WorkspaceInfo } from "./../types/index";
