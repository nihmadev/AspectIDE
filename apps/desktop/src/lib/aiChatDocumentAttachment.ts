import { documentDisplayPath, documentTitle, isMonacoTextDocument, isSpreadsheetEditorDocument } from "./documents";
import type { AiChatAttachmentInput } from "./aiChatTypes";
import {
