...
import { createShellApproval, createTerminalWriteApproval } from "./aiRuntimeApprovals";
...
import { clamp, numberArg, stringArg, toolJson, type ToolResult, type UnknownRecord } from "./aiRuntimeShared";
import { compactTerminalContext, compactTerminalSession, selectTerminalSession, terminalWritePreview } from "./aiRuntimeTerminal";
