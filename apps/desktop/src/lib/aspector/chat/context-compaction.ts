import { reasoningPayload, requestChatCompletion } from "./transport";
import type { AiChatMessage, AiChatToolCall } from "./types";
...
import { firstChoice, type ChatCompletionMessage } from "./transport";
