...
import { createTurnTimeline, type TurnTimeline } from "./timeline";
import { runAutomaticPostEditVerification, isFileEditToolName } from "./../automatic/verification";
import { attachTurnCostEstimate, estimateTurnUsageFromAssistant, extractTurnTokenUsage, mergeTurnTokenUsage } from "./../utils/usage/turn-usage";
import type { AiChatTurnTokenUsage } from "./types";
import { consumeStopAfterToolRound } from "./turn-runtime";
import { clearAiTurnActivity, extractToolPath, setAiTurnActivity } from "./../utils/turn-activity";
import { firstChoice, readReasoningDelta, requestChatCompletion, type ChatCompletionMessage, type ChatCompletionResult, type OpenAiToolCall } from "./transport";
import { ToolApprovalRejectedError } from "./../runtime/tool-approval";
import { collectChangedPathsFromToolResult, createRunningToolCall, formatToolOutput } from "./../runtime/tool-bridge";
import { runRuntimeTool } from "./../runtime/tool-dispatch";
import type { RuntimeToolSession } from "./../runtime/tool-session";
import type { AiModelConfig } from "./../utils/preferences";
import {
...
import { buildToolStepsExhaustedBlock } from "./../utils/system-prompt";
import { activeDocumentContextMaxChars, buildInitialMessages } from "./../runtime/prompt";
import { isRecord, readErrorMessage, truncateText } from "./../runtime/shared";
