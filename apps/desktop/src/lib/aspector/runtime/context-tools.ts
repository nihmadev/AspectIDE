...
import { recordContextBudgetReport } from "./../chat/context-report";
import { buildAiProjectIndexSnapshot } from "./../utils/project-index";
import {
...
import { diagnosticsContext, gitContext } from "./diagnostics";
import {
  compactIndexedFile,
...
import { normalizePathSlashes } from "./shared";
import { countLines } from "./patch";
import { activeDocumentContextMaxChars } from "./prompt";
import { globFiles, grepTool, impactAnalysis, relatedFiles } from "./explore-tools";
...
async function resolveIndexLanguages(entries: import("./../../types/index").FsEntry[], workspaceRoot: string, options: import("./../utils/project-index").BuildAiProjectIndexOptions): Promise<import("./../utils/project-index").AiProjectIndexSnapshot> {
  if (isTauriRuntime()) {
