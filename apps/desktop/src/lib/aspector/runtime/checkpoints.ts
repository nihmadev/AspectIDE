import type { PersistedFileCheckpoint } from "./../chat/checkpoint-store";
import { getFileCheckpoint, listFileCheckpoints, removeFileCheckpoint, upsertFileCheckpoint, workspaceCheckpointKey } from "./../chat/checkpoint-store";
import type { AiChatSendInput, AiToolApprovalRequest } from "./../chat/types";
import { createCheckpointRestoreApproval } from "./approvals";
import { mergeDiffAndStatusFiles } from "./diagnostics";
import { createRelatedFileDescriptor, isPathInsideWorkspace, resolveWorkspacePath } from "./file-context";
import { buildNumberedPreview, countLines, type RuntimePatchOperation } from "./patch";
import { booleanArg, clamp, normalizePathSlashes, numberArg, readErrorMessage, stringArg, stringArrayArg, toolJson, truncateText, type ToolResult, type UnknownRecord } from "./shared";
