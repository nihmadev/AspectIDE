...
import { recordTurnCheckpointFileChanges } from "./../chat/turn-checkpoints";
import { shouldSkipEditReview } from "./../utils/file-review/policy";
import { captureFileTextSnapshot, registerPendingFileReview, type FileTextSnapshot } from "./../utils/pending-file-review";
import { createDeleteApproval, createPatchApproval, createStrReplaceApproval, createWriteApproval } from "./approvals";
import { ensurePathsInFileCheckpoint } from "./checkpoints";
import { patchOperationsArg } from "./patch";
import { booleanArg, clamp, maxToolOutputChars, normalizePathSlashes, numberArg, readErrorMessage, stringArg, truncateText, type ToolResult, type UnknownRecord } from "./shared";
