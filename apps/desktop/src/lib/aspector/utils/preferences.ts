import { automaticAgentProfileInstructions } from "./../automatic/mode-instructions";
import {
...
import { defaultMaxParallelSubagents, maxParallelSubagentsMax, maxParallelSubagentsMin } from "./../subagents/policy";
