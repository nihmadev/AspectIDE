...
type AspectorContextIndicatorProps = {
  contextOpen: boolean;
  contextTitle: string;
...
export function AspectorContextIndicator({
  contextOpen,
  contextTitle,
  contextUsage,
  contextDrops,
...
function AspectorContextPopover({
  contextUsage,
  level,
  meterRows,
  onCompact,
