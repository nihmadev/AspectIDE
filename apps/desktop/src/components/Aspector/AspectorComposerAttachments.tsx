...
type AspectorComposerAttachmentsProps = {
...
export function mapComposerAttachments(attachments: ComposerAttachment[]): AspectorComposerAttachmentView[] {
...
export const AspectorComposerAttachments = memo(function AspectorComposerAttachments({ attachments, draggingFiles, removeAttachment, t }: AspectorComposerAttachmentsProps) {
  ...
  const chipIcon = (attachment: AspectorComposerAttachmentView) => {
