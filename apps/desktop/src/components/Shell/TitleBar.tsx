    ...
    <header className="title-bar" onPointerDown={handleTitleBarPointerDown}>
      ...
      <div className="title-left">
        <span className="app-cube">
          <img src="/aspect-mark.svg" alt="Aspect IDE" draggable={false} />
        </span>
        <span className="app-version" title={`Aspect IDE v${__APP_VERSION__}`}>v{__APP_VERSION__}</span>
      ...
      <div className="title-actions" data-agent-mode={workspaceMode === "agent"}>
        {/* Editor-layout toggles are IDE-view controls вЂ” hidden in Agent view
