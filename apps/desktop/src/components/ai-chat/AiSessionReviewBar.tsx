...
import { requestFileReviewFocus } from "../../lib/aiFileReviewBridge";
import { openWorkspaceEditorPath } from "../../lib/openWorkspaceEditorPath";
import type { TranslateFn } from "../../lib/i18n/useTranslation";

type AiSessionReviewBarProps = {
 ...
 */
export function AiSessionReviewBar({ sessionId, t }: AiSessionReviewBarProps) {
