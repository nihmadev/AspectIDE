...
import { slashCommandDescription, slashCommandLabel, type SlashCommandMatch } from "../../lib/aiChatSlashCommands";
import type { TranslateFn } from "../../lib/i18n/useTranslation";

type AiChatSlashMenuProps = {
  activeIndex: number;
...
export function AiChatSlashMenu({ activeIndex, commands, menuRef, onHighlight, onSelect, t }: AiChatSlashMenuProps) {
