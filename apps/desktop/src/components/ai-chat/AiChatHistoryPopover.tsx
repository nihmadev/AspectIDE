...
type AiChatHistoryPopoverProps = {
...
export function AiChatHistoryPopover({ workspaceRoot }: AiChatHistoryPopoverProps) {
  ...
  const exportSession = (session: AiChatSession) => {
    ...
    anchor.href = url;
    anchor.download = `${session.title.trim() || "lux-chat"}.md`;
    anchor.click();
