...
import type { PendingToolApprovalRef } from "../../lib/aiChatPendingApproval";
import type { AiToolApprovalDecision } from "../../lib/aiChatTypes";
import type { TranslateFn } from "../../lib/i18n/useTranslation";

type AiChatGlobalApprovalBannerProps = {
...
export function AiChatGlobalApprovalBanner({
  pending,
  hiddenOnActiveSession,
  onFocusSession,
  onDecision,
  t,
}: AiChatGlobalApprovalBannerProps) {
