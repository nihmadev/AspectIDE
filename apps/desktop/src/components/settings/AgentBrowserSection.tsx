...
import { luxCommands, type AgentBrowserStatusResponse } from "../../lib/tauri";
import { NumberSetting, SettingsGrid, SettingsPanel, TextSetting, ToggleSetting } from "./SettingsControls";

/** Advanced fields, in display order — also drives the disclosure's count badge
 ...
 * the 11 rarely-touched knobs (domains, provider, proxy, ports, paths, …) tucked
 ...
 * persisted preference) — it's a viewing convenience, not a setting.
 */
          ...
          <button
            ...
            onClick={() => {
              ...
              void luxCommands.agentBrowserInstall({
                ...
                // (e.g. npm missing, network down). Surface that text verbatim —
